...
const SearchTravelDate = ({
  ...
  return (
    <div>
      {!isMobileView ? (
        <div>
          <div className="flex flex-row items-center gap-2 overflow-x-auto py-1 scrollbar-hide">
            <div
              ref={inputAnchorRef}
              onClick={() => setDesktopCalendarOpen(true)}
              className="flex items-center justify-between rounded-[14px] border-2 border-[#E0E0E0] px-3 py-2 bg-white backdrop-blur cursor-pointer flex-shrink-0"
          ...
          {desktopCalendarOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center" onClick={() => setDesktopCalendarOpen(false)}>
          ...
          <>
            <div onClick={() => setShowCalender(true)} className="flex items-center justify-between w-full max-w-[315px] h-[46px] rounded-[14px] border-2 border-[#E0E0E0] px-3 py-2 bg-white backdrop-blur mt-1.5 cursor-pointer">
              {!isArabic ? (
                <input
                  placeholder={t("select_travel_date")}
                  value={inputValue}
            ...
            <div className="w-full max-w-[315px] mt-2 flex flex-col gap-2">
